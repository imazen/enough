...
/// Published crates in this workspace (the `tests/test-*` members are
/// internal, `publish = false`).
const CRATES: &[&str] = &["enough", "almost-enough", "enough-tokio", "enough-ffi"];
    ...
    for package in CRATES {
        ...
        doc.push_str(&format!(
            "# {package} public API surface\n\
             # Generated by crates/enough/tests/public_api_doc.rs via `cargo public-api --simplified`\n\
